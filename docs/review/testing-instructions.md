...
2. Click "Turn on the storefront assistant". The theme editor opens App embeds with "Busymate AI assistant" enabled; click Save if prompted. Manual path: Online Store > Themes > Customize > App embeds.
